...
export const messages: LocaleRecord<AppMessages> = {
  ja: {
    ...
    contactPage: {
      metadata: { title: "お問い合わせ | Japan Travel Buddy", description: "Japan Travel Buddyへのお問い合わせ" },
      title: "お問い合わせ",
      introduction: "Japan Travel Buddyをご利用いただき、ありがとうございます。",
      invitation: "ご質問、ご意見、ご提案がありましたら、お気軽にお問い合わせください。",
      supportTitle: "サポート",
      supportDescription: "不具合のご報告、機能のご要望、サービスに関するお問い合わせを受け付けています。",
      contactMethodTitle: "お問い合わせ方法",
      contactMethodDescription: "以下のメールアドレスへご連絡ください。リンクをクリックするとメールソフトが開きます。",
      responseTimeTitle: "返信について",
  ...
  en: {
    ...
    contactPage: {
      ...
      contactMethodDescription: "Please email us at the address below. Click the link to open your email app.",
